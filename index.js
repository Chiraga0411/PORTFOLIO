...
if(document.querySelector("#theme").getAttribute("href")=="index2.css"){
    document.querySelector("#theme").setAttribute("href","index1.css")
    ...
    document.querySelector("#theme").setAttribute("href","index2.css")
